...
public class Receiver {
    ...
    public static void main(String[] args) throws IOException 
    {
        ...
        // TRASFORMA IN MAIUSCOLO E INVIA RISPOSTA
        String risposta = msg.toUpperCase();
        System.out.println("Receiver, invio risposta in maiuscolo: " + risposta);
        DatagramPacket sendPacket = new DatagramPacket(risposta.getBytes(), risposta.length(), packet.getAddress(), packet.getPort());
